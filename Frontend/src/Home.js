        ...
        <div className='homepage'>
            ...
            <img src={logo} className="homepage-logo" alt="HerGuard Logo" /> 
                ...
                <main className='homepage-content'>
                    <section>
                    <p> place where you can feel safe with us in your pocket,
                                let us help you connect with your loved ones in dire situations 
                                and let us help you keep you safe.In this app you will find ways to communicate with your loved ones when in-need,
                                if you do not feel safe just connect and share your location, 
                                a loved one out there will be your eyes n the way.
                            </p>
                        <h2>features</h2>
                        <ul>
